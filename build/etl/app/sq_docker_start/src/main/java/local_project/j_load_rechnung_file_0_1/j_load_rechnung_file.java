...
package local_project.j_load_rechnung_file_0_1;
...
/**
 * Job: j_load_rechnung_file Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_load_rechnung_file implements TalendJob {
...
public String getDaisie_db_username(){
	...
	private final String jobName = "j_load_rechnung_file";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_load_rechnung_file.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_load_rechnung_file.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class rechnung_to_stageStruct implements routines.system.IPersistableRow<rechnung_to_stageStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_rechnung_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_rechnung_file = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_j_load_rechnung_file) {
     ...
     * Compare keys
     */
    public int compareTo(rechnung_to_stageStruct other) {
...
public static class rechnung_csv_loadStruct implements routines.system.IPersistableRow<rechnung_csv_loadStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_rechnung_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_rechnung_file = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(rechnung_csv_loadStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		rechnung_csv_loadStruct rechnung_csv_load = new rechnung_csv_loadStruct();
rechnung_to_stageStruct rechnung_to_stage = new rechnung_to_stageStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"rechnung_to_stage");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ta_stg_rechnung");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ta_stg_rechnung");
}
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"rechnung_nr\",\"rechnungsdatum\",\"kundennummer\") VALUES (?,?,?)";
 ...
 */
	...
	currentComponent="tMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"rechnung_csv_load");
					}
...
rechnung_to_stageStruct rechnung_to_stage_tmp = new rechnung_to_stageStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:TnQugdAFLiWPZzp0Q4WAI2wGBzWzoOgcRSLs/Q==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Sheet3", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			rechnung_csv_load = new rechnung_csv_loadStruct();
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				rechnung_csv_load.rechnung_nr = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				rechnung_csv_load.rechnung_nr = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "rechnungsdatum";
				...
				if(1<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							rechnung_csv_load.rechnungsdatum = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                rechnung_csv_load.rechnungsdatum = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
globalMap.put("tFileInputExcel_1_ERROR_MESSAGE",e.getMessage());
				...
				rechnung_csv_load.rechnungsdatum = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "kundennummer";

				rechnung_csv_load.kundennummer = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				rechnung_csv_load.kundennummer = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 ...
 */
// Start of branch "rechnung_csv_load"
if(rechnung_csv_load != null) { 
...
rechnung_to_stage = null;


// # Output table : 'rechnung_to_stage'
rechnung_to_stage_tmp.rechnung_nr = rechnung_csv_load.rechnung_nr ;
rechnung_to_stage_tmp.rechnungsdatum = rechnung_csv_load.rechnungsdatum ;
rechnung_to_stage_tmp.kundennummer = rechnung_csv_load.kundennummer ;
rechnung_to_stage = rechnung_to_stage_tmp;
// ###############################
 ...
 */
// Start of branch "rechnung_to_stage"
if(rechnung_to_stage != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(rechnung_to_stage.rechnung_nr == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, rechnung_to_stage.rechnung_nr);
}

                    if(rechnung_to_stage.rechnungsdatum != null) {
pstmt_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(rechnung_to_stage.rechnungsdatum.getTime()));
} else {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(rechnung_to_stage.kundennummer == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, rechnung_to_stage.kundennummer);
}
...
} // End of branch "rechnung_to_stage"
...
} // End of branch "rechnung_csv_load"
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"rechnung_csv_load");
			  	}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"rechnung_to_stage");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final j_load_rechnung_file j_load_rechnung_fileClass = new j_load_rechnung_file();

        int exitCode = j_load_rechnung_fileClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_load_rechnung_file.class.getClassLoader().getResourceAsStream("local_project/j_load_rechnung_file_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_load_rechnung_file.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_load_rechnung_file");
        }
...
/************************************************************************************************
 *     89828 characters generated by Talend Open Studio for Data Integration 
