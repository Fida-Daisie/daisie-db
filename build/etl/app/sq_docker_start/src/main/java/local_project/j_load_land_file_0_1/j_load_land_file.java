...
package local_project.j_load_land_file_0_1;
...
/**
 * Job: j_load_land_file Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_load_land_file implements TalendJob {
...
public String getDaisie_db_username(){
	...
	private final String jobName = "j_load_land_file";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_load_land_file.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_load_land_file.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class land_to_stageStruct implements routines.system.IPersistableRow<land_to_stageStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_land_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_land_file = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_j_load_land_file.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_j_load_land_file.length == 0) {
   					commonByteArray_LOCAL_PROJECT_j_load_land_file = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_j_load_land_file = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_j_load_land_file, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_j_load_land_file, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_j_load_land_file, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_j_load_land_file, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_j_load_land_file) {
     ...
     * Compare keys
     */
    public int compareTo(land_to_stageStruct other) {
...
public static class land_csv_loadStruct implements routines.system.IPersistableRow<land_csv_loadStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_land_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_land_file = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(land_csv_loadStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		land_csv_loadStruct land_csv_load = new land_csv_loadStruct();
land_to_stageStruct land_to_stage = new land_to_stageStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"land_to_stage");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ta_stg_land");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ta_stg_land");
}
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id\",\"name_land\") VALUES (?,?)";
 ...
 */
	...
	currentComponent="tMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"land_csv_load");
					}
...
land_to_stageStruct land_to_stage_tmp = new land_to_stageStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ksRiMudAvEtNZHjN2hEFmeMN8PBMCaQq8XvZXw==");
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			land_csv_load = new land_csv_loadStruct();
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				land_csv_load.id = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				land_csv_load.id = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "name_land";

				land_csv_load.name_land = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				land_csv_load.name_land = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 ...
 */
// Start of branch "land_csv_load"
if(land_csv_load != null) { 
...
// # Output table : 'land_to_stage'
land_to_stage_tmp.id = land_csv_load.id ;
land_to_stage_tmp.name_land = land_csv_load.name_land ;
land_to_stage = land_to_stage_tmp;
// ###############################
 ...
 */
// Start of branch "land_to_stage"
if(land_to_stage != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, land_to_stage.id);

                    if(land_to_stage.name_land == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, land_to_stage.name_land);
}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"land_csv_load");
			  	}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"land_to_stage");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final j_load_land_file j_load_land_fileClass = new j_load_land_file();

        int exitCode = j_load_land_fileClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_load_land_file.class.getClassLoader().getResourceAsStream("local_project/j_load_land_file_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_load_land_file.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_load_land_file");
        }
...
/************************************************************************************************
 *     87700 characters generated by Talend Open Studio for Data Integration 
