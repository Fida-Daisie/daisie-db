...
package local_project.j_load_artikel_file_0_1;
...
/**
 * Job: j_load_artikel_file Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_load_artikel_file implements TalendJob {
...
public String getDaisie_db_username(){
	...
	private final String jobName = "j_load_artikel_file";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_load_artikel_file.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_load_artikel_file.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:uiWvc1RIUpg/vlAv5gejMPE39HtBVOvC/7XZH+x7zFE=");
...
public static class artikel_to_stageStruct implements routines.system.IPersistableRow<artikel_to_stageStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_artikel_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_artikel_file = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_j_load_artikel_file.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_j_load_artikel_file.length == 0) {
   					commonByteArray_LOCAL_PROJECT_j_load_artikel_file = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_j_load_artikel_file = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_j_load_artikel_file, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_j_load_artikel_file, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_j_load_artikel_file, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_j_load_artikel_file, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_j_load_artikel_file) {
					...
					this.artikelbeschreibung = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.artikelpreis = dis.readDouble();
           				}
					...
					// Double
						...
						if(this.artikelpreis == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.artikelpreis);
		            	}
     ...
     * Compare keys
     */
    public int compareTo(artikel_to_stageStruct other) {
...
public static class artikel_csv_loadStruct implements routines.system.IPersistableRow<artikel_csv_loadStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_artikel_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_artikel_file = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(artikel_csv_loadStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		artikel_csv_loadStruct artikel_csv_load = new artikel_csv_loadStruct();
artikel_to_stageStruct artikel_to_stage = new artikel_to_stageStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"artikel_to_stage");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ta_stg_artikel");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ta_stg_artikel");
}
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"artikel_nr\",\"artikelbeschreibung\",\"artikelpreis\") VALUES (?,?,?)";
 ...
 */
	...
	currentComponent="tMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"artikel_csv_load");
					}
...
artikel_to_stageStruct artikel_to_stage_tmp = new artikel_to_stageStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ZtyEtXRzPpiKgI3RjNgjsxjgy+OTbs4hdFRNzQ==");
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Sheet0", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			artikel_csv_load = new artikel_csv_loadStruct();
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				artikel_csv_load.artikel_nr = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				artikel_csv_load.artikel_nr = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "artikelbeschreibung";

				artikel_csv_load.artikelbeschreibung = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				artikel_csv_load.artikelbeschreibung = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "artikelpreis";

				artikel_csv_load.artikelpreis = ParserUtils.parseTo_Double(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				artikel_csv_load.artikelpreis = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 ...
 */
// Start of branch "artikel_csv_load"
if(artikel_csv_load != null) { 
...
artikel_to_stage = null;


// # Output table : 'artikel_to_stage'
artikel_to_stage_tmp.artikel_nr = artikel_csv_load.artikel_nr ;
artikel_to_stage_tmp.artikelbeschreibung = artikel_csv_load.artikelbeschreibung ;
artikel_to_stage_tmp.artikelpreis = artikel_csv_load.artikelpreis ;
artikel_to_stage = artikel_to_stage_tmp;
// ###############################
 ...
 */
// Start of branch "artikel_to_stage"
if(artikel_to_stage != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(artikel_to_stage.artikel_nr == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, artikel_to_stage.artikel_nr);
}

                    if(artikel_to_stage.artikelbeschreibung == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, artikel_to_stage.artikelbeschreibung);
}

                    if(artikel_to_stage.artikelpreis == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(3, artikel_to_stage.artikelpreis);
}
...
} // End of branch "artikel_to_stage"
...
} // End of branch "artikel_csv_load"
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"artikel_csv_load");
			  	}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"artikel_to_stage");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final j_load_artikel_file j_load_artikel_fileClass = new j_load_artikel_file();

        int exitCode = j_load_artikel_fileClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_load_artikel_file.class.getClassLoader().getResourceAsStream("local_project/j_load_artikel_file_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_load_artikel_file.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_load_artikel_file");
        }
...
/************************************************************************************************
 *     89527 characters generated by Talend Open Studio for Data Integration 
