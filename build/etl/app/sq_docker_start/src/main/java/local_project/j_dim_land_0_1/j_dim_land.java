...
package local_project.j_dim_land_0_1;
...
/**
 * Job: j_dim_land Purpose: Beladung Dimensionstabelle<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_dim_land implements TalendJob {
...
public String getDaisie_db_schema(){
	...
	private final String jobName = "j_dim_land";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_dim_land.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class zu_insert_neue_saetzeStruct implements routines.system.IPersistableRow<zu_insert_neue_saetzeStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_dim_land = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_dim_land = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_j_dim_land.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_j_dim_land.length == 0) {
   					commonByteArray_LOCAL_PROJECT_j_dim_land = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_j_dim_land = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_j_dim_land, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_j_dim_land, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_j_dim_land, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_j_dim_land, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_j_dim_land) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ta_dim_land");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ta_dim_land");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"name_land\") VALUES (?)";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								zu_insert_neue_saetze.name_land = null;
							} else {
	                         		
        	zu_insert_neue_saetze.name_land = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
 ...
 */
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(zu_insert_neue_saetze.name_land == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, zu_insert_neue_saetze.name_land);
}
 ...
 */
    ...
    public static void main(String[] args){
        final j_dim_land j_dim_landClass = new j_dim_land();

        int exitCode = j_dim_landClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_dim_land.class.getClassLoader().getResourceAsStream("local_project/j_dim_land_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_dim_land.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_dim_land");
        }
...
/************************************************************************************************
 *     64148 characters generated by Talend Open Studio for Data Integration 
