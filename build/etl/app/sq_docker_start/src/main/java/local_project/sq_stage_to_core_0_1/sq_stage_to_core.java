...
package local_project.sq_stage_to_core_0_1;
...
/**
 * Job: sq_stage_to_core Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class sq_stage_to_core implements TalendJob {
...
public String getDaisie_db_username(){
	...
	private final String jobName = "sq_stage_to_core";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				sq_stage_to_core.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(sq_stage_to_core.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		local_project.j_load_artikel_to_core_0_1.j_load_artikel_to_core childJob_tRunJob_1 = new local_project.j_load_artikel_to_core_0_1.j_load_artikel_to_core();
	    // pass DataSources
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_3 = new java.util.ArrayList<String>();
	        				...
	        				paraList_tRunJob_3.add("--context=AUS_FILE");
	...
	Object obj_tRunJob_3 = null;
		...
		local_project.j_load_land_to_core_0_1.j_load_land_to_core childJob_tRunJob_3 = new local_project.j_load_land_to_core_0_1.j_load_land_to_core();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		local_project.j_load_kunden_to_core_0_1.j_load_kunden_to_core childJob_tRunJob_2 = new local_project.j_load_kunden_to_core_0_1.j_load_kunden_to_core();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		local_project.j_load_rechnung_to_core_0_1.j_load_rechnung_to_core childJob_tRunJob_4 = new local_project.j_load_rechnung_to_core_0_1.j_load_rechnung_to_core();
	    // pass DataSources
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_5 = new java.util.ArrayList<String>();
	        				...
	        				paraList_tRunJob_5.add("--context=AUS_FILE");
	...
	Object obj_tRunJob_5 = null;
		...
		local_project.j_load_rechnung_position_to_core_0_1.j_load_rechnung_position_to_core childJob_tRunJob_5 = new local_project.j_load_rechnung_position_to_core_0_1.j_load_rechnung_position_to_core();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final sq_stage_to_core sq_stage_to_coreClass = new sq_stage_to_core();

        int exitCode = sq_stage_to_coreClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sq_stage_to_core.class.getClassLoader().getResourceAsStream("local_project/sq_stage_to_core_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sq_stage_to_core.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sq_stage_to_core");
        }
...
/************************************************************************************************
 *     77470 characters generated by Talend Open Studio for Data Integration 
