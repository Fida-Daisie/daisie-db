...
package local_project.j_load_kunden_file_0_1;
...
/**
 * Job: j_load_kunden_file Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_load_kunden_file implements TalendJob {
...
public String getDaisie_db_username(){
	...
	private final String jobName = "j_load_kunden_file";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_load_kunden_file.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_load_kunden_file.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class kunden_to_stageStruct implements routines.system.IPersistableRow<kunden_to_stageStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_kunden_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_kunden_file = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_j_load_kunden_file) {
     ...
     * Compare keys
     */
    public int compareTo(kunden_to_stageStruct other) {
...
public static class kunden_csv_loadStruct implements routines.system.IPersistableRow<kunden_csv_loadStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_kunden_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_kunden_file = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(kunden_csv_loadStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		kunden_csv_loadStruct kunden_csv_load = new kunden_csv_loadStruct();
kunden_to_stageStruct kunden_to_stage = new kunden_to_stageStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"kunden_to_stage");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ta_stg_kunde");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ta_stg_kunde");
}
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"kundennummer\",\"id_land\") VALUES (?,?)";
 ...
 */
	...
	currentComponent="tMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"kunden_csv_load");
					}
...
kunden_to_stageStruct kunden_to_stage_tmp = new kunden_to_stageStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:VYBJHAonqdwButiTp11k0tJUsK3Sf7hTG8AHBg==");
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			kunden_csv_load = new kunden_csv_loadStruct();
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				kunden_csv_load.kundennummer = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				kunden_csv_load.kundennummer = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "id_land";

				kunden_csv_load.id_land = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				kunden_csv_load.id_land = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 ...
 */
// Start of branch "kunden_csv_load"
if(kunden_csv_load != null) { 
...
kunden_to_stage = null;


// # Output table : 'kunden_to_stage'
kunden_to_stage_tmp.kundennummer = kunden_csv_load.kundennummer ;
kunden_to_stage_tmp.id_land = kunden_csv_load.id_land ;
kunden_to_stage = kunden_to_stage_tmp;
// ###############################
 ...
 */
// Start of branch "kunden_to_stage"
if(kunden_to_stage != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(kunden_to_stage.kundennummer == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, kunden_to_stage.kundennummer);
}

                    if(kunden_to_stage.id_land == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, kunden_to_stage.id_land);
}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"kunden_csv_load");
			  	}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"kunden_to_stage");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final j_load_kunden_file j_load_kunden_fileClass = new j_load_kunden_file();

        int exitCode = j_load_kunden_fileClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_load_kunden_file.class.getClassLoader().getResourceAsStream("local_project/j_load_kunden_file_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_load_kunden_file.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_load_kunden_file");
        }
...
/************************************************************************************************
 *     83925 characters generated by Talend Open Studio for Data Integration 
