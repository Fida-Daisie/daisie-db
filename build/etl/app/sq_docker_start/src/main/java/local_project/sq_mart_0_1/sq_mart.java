...
package local_project.sq_mart_0_1;
...
/**
 * Job: sq_mart Purpose: Sequenz für Mart-Beladung<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class sq_mart implements TalendJob {
...
public String getDaisie_db_username(){
	...
	private final String jobName = "sq_mart";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(sq_mart.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		local_project.j_dim_artikel_0_1.j_dim_artikel childJob_tRunJob_1 = new local_project.j_dim_artikel_0_1.j_dim_artikel();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		local_project.j_dim_land_0_1.j_dim_land childJob_tRunJob_2 = new local_project.j_dim_land_0_1.j_dim_land();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		local_project.j_dim_zeit_0_1.j_dim_zeit childJob_tRunJob_3 = new local_project.j_dim_zeit_0_1.j_dim_zeit();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		local_project.j_mart_artikelverkauf_0_1.j_mart_artikelverkauf childJob_tRunJob_4 = new local_project.j_mart_artikelverkauf_0_1.j_mart_artikelverkauf();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final sq_mart sq_martClass = new sq_mart();

        int exitCode = sq_martClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sq_mart.class.getClassLoader().getResourceAsStream("local_project/sq_mart_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sq_mart.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sq_mart");
        }
...
/************************************************************************************************
 *     67624 characters generated by Talend Open Studio for Data Integration 
