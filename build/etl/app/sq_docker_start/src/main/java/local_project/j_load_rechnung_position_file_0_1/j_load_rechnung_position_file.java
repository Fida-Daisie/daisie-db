...
package local_project.j_load_rechnung_position_file_0_1;
...
/**
 * Job: j_load_rechnung_position_file Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_load_rechnung_position_file implements TalendJob {
...
public String getDaisie_db_username(){
	...
	private final String jobName = "j_load_rechnung_position_file";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_load_rechnung_position_file.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_load_rechnung_position_file.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class rechnungPosition_to_stageStruct implements routines.system.IPersistableRow<rechnungPosition_to_stageStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_rechnung_position_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file.length == 0) {
   					commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_j_load_rechnung_position_file) {
     ...
     * Compare keys
     */
    public int compareTo(rechnungPosition_to_stageStruct other) {
...
public static class rechnungPosition_csv_loadStruct implements routines.system.IPersistableRow<rechnungPosition_csv_loadStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_j_load_rechnung_position_file = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_j_load_rechnung_position_file = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(rechnungPosition_csv_loadStruct other) {
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		rechnungPosition_csv_loadStruct rechnungPosition_csv_load = new rechnungPosition_csv_loadStruct();
rechnungPosition_to_stageStruct rechnungPosition_to_stage = new rechnungPosition_to_stageStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"rechnungPosition_to_stage");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ta_stg_rechnung_position");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ta_stg_rechnung_position");
}
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"rechnung_nr\",\"rechnung_position\",\"artikel_nr\",\"menge\") VALUES (?,?,?,?)";
 ...
 */
	...
	currentComponent="tMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"rechnungPosition_csv_load");
					}
...
rechnungPosition_to_stageStruct rechnungPosition_to_stage_tmp = new rechnungPosition_to_stageStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:sL6Y91SFWr3E4xt15SJwIdR9bYWq8ZcZ24BIOQ==");
		...
		Object source_tFileInputExcel_1 = context.daisie_csvFilePath;
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Sheet4", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
		    ...
		    rechnungPosition_csv_load = null;
			...
			rechnungPosition_csv_load = new rechnungPosition_csv_loadStruct();
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "rechnung_nr";

				rechnungPosition_csv_load.rechnung_nr = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				rechnungPosition_csv_load.rechnung_nr = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "rechnung_position";

				rechnungPosition_csv_load.rechnung_position = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				rechnungPosition_csv_load.rechnung_position = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "artikel_nr";

				rechnungPosition_csv_load.artikel_nr = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				rechnungPosition_csv_load.artikel_nr = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "menge";

				rechnungPosition_csv_load.menge = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				rechnungPosition_csv_load.menge = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
 ...
 */
// Start of branch "rechnungPosition_csv_load"
if(rechnungPosition_csv_load != null) { 
...
rechnungPosition_to_stage = null;


// # Output table : 'rechnungPosition_to_stage'
rechnungPosition_to_stage_tmp.rechnung_nr = rechnungPosition_csv_load.rechnung_nr ;
rechnungPosition_to_stage_tmp.rechnung_position = rechnungPosition_csv_load.rechnung_position ;
rechnungPosition_to_stage_tmp.artikel_nr = rechnungPosition_csv_load.artikel_nr ;
rechnungPosition_to_stage_tmp.menge = rechnungPosition_csv_load.menge ;
rechnungPosition_to_stage = rechnungPosition_to_stage_tmp;
// ###############################
 ...
 */
// Start of branch "rechnungPosition_to_stage"
if(rechnungPosition_to_stage != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(rechnungPosition_to_stage.rechnung_nr == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, rechnungPosition_to_stage.rechnung_nr);
}

                    if(rechnungPosition_to_stage.rechnung_position == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, rechnungPosition_to_stage.rechnung_position);
}

                    if(rechnungPosition_to_stage.artikel_nr == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, rechnungPosition_to_stage.artikel_nr);
}

                    if(rechnungPosition_to_stage.menge == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(4, rechnungPosition_to_stage.menge);
}
...
} // End of branch "rechnungPosition_to_stage"
...
} // End of branch "rechnungPosition_csv_load"
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"rechnungPosition_csv_load");
			  	}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"rechnungPosition_to_stage");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final j_load_rechnung_position_file j_load_rechnung_position_fileClass = new j_load_rechnung_position_file();

        int exitCode = j_load_rechnung_position_fileClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_load_rechnung_position_file.class.getClassLoader().getResourceAsStream("local_project/j_load_rechnung_position_file_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_load_rechnung_position_file.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("daisie_csvFilePath", "id_String");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_load_rechnung_position_file");
        }
...
/************************************************************************************************
 *     92854 characters generated by Talend Open Studio for Data Integration 
 *     on the 30. März 2023 um 10:04:13 MESZ
 ************************************************************************************************/