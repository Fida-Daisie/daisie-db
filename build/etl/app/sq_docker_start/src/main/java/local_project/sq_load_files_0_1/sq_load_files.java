...
package local_project.sq_load_files_0_1;
...
/**
 * Job: sq_load_files Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class sq_load_files implements TalendJob {
...
public String getDaisie_db_username(){
	...
	private final String jobName = "sq_load_files";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				sq_load_files.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(sq_load_files.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
			...
			if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_1_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/postgresql-42.2.14.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;j_load_artikel_file_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "local_project.j_load_artikel_file_0_1.j_load_artikel_file");
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "--context=AUS_FILE");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "-cp");
		      					...
		      					String classpath_tRunJob_1_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/j_load_artikel_file_0_1.jar:";
	...
	List<String> parametersToEncrypt_tRunJob_1 = new java.util.ArrayList<String>();
			...
			parametersToEncrypt_tRunJob_1 .add("daisie_db_password");
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    paraList_tRunJob_1.add("--context_type " + "daisie_db_password" + "=" + "id_Password");
	...
	Object obj_tRunJob_1 = null;
		...
		System.out.println("tRunJob_1 in sq_load_files call j_load_artikel_file with:\n\n" + paraListForLog_tRunJob_1 + "\n");
 ...
 */
			...
			if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_3_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/postgresql-42.2.14.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;j_load_land_file_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(classpath_tRunJob_3_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "local_project.j_load_land_file_0_1.j_load_land_file");
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "--context=AUS_FILE");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-cp");
		      					...
		      					String classpath_tRunJob_3_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/j_load_land_file_0_1.jar:";
	...
	List<String> parametersToEncrypt_tRunJob_3 = new java.util.ArrayList<String>();
			...
			parametersToEncrypt_tRunJob_3 .add("daisie_db_password");
			
		
		context.synchronizeContext();
            class ContextProcessor_tRunJob_3 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_3.put("daisie_db_additionalParams", context.daisie_db_additionalParams);
                    paraList_tRunJob_3.add("--context_type " + "daisie_db_additionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("daisie_db_database", context.daisie_db_database);
                    paraList_tRunJob_3.add("--context_type " + "daisie_db_database" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("daisie_db_password", context.daisie_db_password);
                    paraList_tRunJob_3.add("--context_type " + "daisie_db_password" + "=" + "id_Password");
                    parentContextMap_tRunJob_3.put("daisie_db_port", context.daisie_db_port);
                    paraList_tRunJob_3.add("--context_type " + "daisie_db_port" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("daisie_db_schema", context.daisie_db_schema);
                    paraList_tRunJob_3.add("--context_type " + "daisie_db_schema" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("daisie_db_server", context.daisie_db_server);
                    paraList_tRunJob_3.add("--context_type " + "daisie_db_server" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("daisie_db_username", context.daisie_db_username);
                    paraList_tRunJob_3.add("--context_type " + "daisie_db_username" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("daisie_csvFilePath", context.daisie_csvFilePath);
                    paraList_tRunJob_3.add("--context_type " + "daisie_csvFilePath" + "=" + "id_File");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_3 = null;
		...
		System.out.println("tRunJob_3 in sq_load_files call j_load_land_file with:\n\n" + paraListForLog_tRunJob_3 + "\n");
 ...
 */
			...
			if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_2_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/postgresql-42.2.14.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;j_load_kunden_file_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(classpath_tRunJob_2_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "local_project.j_load_kunden_file_0_1.j_load_kunden_file");
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "--context=AUS_FILE");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-cp");
		      					...
		      					String classpath_tRunJob_2_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/j_load_kunden_file_0_1.jar:";
	...
	List<String> parametersToEncrypt_tRunJob_2 = new java.util.ArrayList<String>();
			...
			parametersToEncrypt_tRunJob_2 .add("daisie_db_password");
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_2 {
                    ...
                    paraList_tRunJob_2.add("--context_type " + "daisie_db_password" + "=" + "id_Password");
	...
	Object obj_tRunJob_2 = null;
		...
		System.out.println("tRunJob_2 in sq_load_files call j_load_kunden_file with:\n\n" + paraListForLog_tRunJob_2 + "\n");
 ...
 */
			...
			if (osName_tRunJob_4 != null && osName_tRunJob_4.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_4.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_4_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/postgresql-42.2.14.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;j_load_rechnung_file_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, dealChildJobLibrary_tRunJob_4.replaceJarPathsFromCrcMap(classpath_tRunJob_4_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, "local_project.j_load_rechnung_file_0_1.j_load_rechnung_file");
		      					...
		      					jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, "--context=AUS_FILE");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_4.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, "-cp");
		      					...
		      					String classpath_tRunJob_4_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/j_load_rechnung_file_0_1.jar:";
	...
	List<String> parametersToEncrypt_tRunJob_4 = new java.util.ArrayList<String>();
			...
			parametersToEncrypt_tRunJob_4 .add("daisie_db_password");
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_4 {
                    ...
                    paraList_tRunJob_4.add("--context_type " + "daisie_db_password" + "=" + "id_Password");
	...
	Object obj_tRunJob_4 = null;
		...
		System.out.println("tRunJob_4 in sq_load_files call j_load_rechnung_file with:\n\n" + paraListForLog_tRunJob_4 + "\n");
 ...
 */
			...
			if (osName_tRunJob_5 != null && osName_tRunJob_5.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_5.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_5_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.13.2.jar;../lib/log4j-api-2.13.2.jar;../lib/log4j-core-2.13.2.jar;../lib/log4j-1.2-api-2.13.2.jar;../lib/SparseBitSet-1.2.jar;../lib/commons-math3-3.6.1.jar;../lib/commons-collections4-4.4.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/commons-compress-1.21.jar;../lib/commons-codec-1.14.jar;../lib/curvesapi-1.06.jar;../lib/poi-4.1.2-20200903124306_modified_talend.jar;../lib/dom4j-2.1.3.jar;../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar;../lib/slf4j-api-1.7.29.jar;../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar;../lib/xmlbeans-3.1.0.jar;../lib/postgresql-42.2.14.jar;../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar;../lib/crypto-utils-0.31.12.jar;j_load_rechnung_position_file_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, dealChildJobLibrary_tRunJob_5.replaceJarPathsFromCrcMap(classpath_tRunJob_5_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, "local_project.j_load_rechnung_position_file_0_1.j_load_rechnung_position_file");
		      					...
		      					jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, "--context=AUS_FILE");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_5.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, "-cp");
		      					...
		      					String classpath_tRunJob_5_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.13.2.jar:$ROOT_PATH/../lib/log4j-api-2.13.2.jar:$ROOT_PATH/../lib/log4j-core-2.13.2.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.13.2.jar:$ROOT_PATH/../lib/SparseBitSet-1.2.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/commons-collections4-4.4.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/commons-compress-1.21.jar:$ROOT_PATH/../lib/commons-codec-1.14.jar:$ROOT_PATH/../lib/curvesapi-1.06.jar:$ROOT_PATH/../lib/poi-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.2-20200903124306_modified_talend.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/j_load_rechnung_position_file_0_1.jar:";
	...
	List<String> parametersToEncrypt_tRunJob_5 = new java.util.ArrayList<String>();
			...
			parametersToEncrypt_tRunJob_5 .add("daisie_db_password");
			
		
		context.synchronizeContext();
            class ContextProcessor_tRunJob_5 {
                    private void transmitContext_0() {
                    parentContextMap_tRunJob_5.put("daisie_db_additionalParams", context.daisie_db_additionalParams);
                    paraList_tRunJob_5.add("--context_type " + "daisie_db_additionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("daisie_db_database", context.daisie_db_database);
                    paraList_tRunJob_5.add("--context_type " + "daisie_db_database" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("daisie_db_password", context.daisie_db_password);
                    paraList_tRunJob_5.add("--context_type " + "daisie_db_password" + "=" + "id_Password");
                    parentContextMap_tRunJob_5.put("daisie_db_port", context.daisie_db_port);
                    paraList_tRunJob_5.add("--context_type " + "daisie_db_port" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("daisie_db_schema", context.daisie_db_schema);
                    paraList_tRunJob_5.add("--context_type " + "daisie_db_schema" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("daisie_db_server", context.daisie_db_server);
                    paraList_tRunJob_5.add("--context_type " + "daisie_db_server" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("daisie_db_username", context.daisie_db_username);
                    paraList_tRunJob_5.add("--context_type " + "daisie_db_username" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("daisie_csvFilePath", context.daisie_csvFilePath);
                    paraList_tRunJob_5.add("--context_type " + "daisie_csvFilePath" + "=" + "id_File");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_5 = null;
		...
		System.out.println("tRunJob_5 in sq_load_files call j_load_rechnung_position_file with:\n\n" + paraListForLog_tRunJob_5 + "\n");
 ...
 */
    ...
    public static void main(String[] args){
        final sq_load_files sq_load_filesClass = new sq_load_files();

        int exitCode = sq_load_filesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sq_load_files.class.getClassLoader().getResourceAsStream("local_project/sq_load_files_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sq_load_files.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sq_load_files");
        }
...
/************************************************************************************************
 *     149264 characters generated by Talend Open Studio for Data Integration 
 *     on the 30. März 2023 um 10:04:14 MESZ
 ************************************************************************************************/